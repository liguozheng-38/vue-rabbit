    ...
    <div class="container">
      <div class="bread-container">
        <el-skeleton :loading="loading" animated>
          ...
          <template #default>
            <el-breadcrumb separator=">" v-if="goods.details">
          ...
          <template #template>
            <div class="goods-info">
              ...
              <div class="spec">
                ...
                <el-skeleton-item
                  variant="text"
                  style="width: 40%; height: 30px; margin-top: 10px"
                />
                <el-skeleton-item
                  variant="text"
